...
public class CottonCrusherActivity extends AppCompatActivity {
    ...
    String userId;
    String product_name="Cotton Stalk Crusher Machine";
    String cost="225000";
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cotton_crusher);
