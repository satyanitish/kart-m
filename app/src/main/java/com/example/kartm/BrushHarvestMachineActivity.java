...
public class BrushHarvestMachineActivity extends AppCompatActivity {
    ...
    String userId;
    String product_name="Brush Harvest Machine";
    String cost="27000";
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_brush_harvest_machine);
